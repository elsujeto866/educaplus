...
/**
 * Page-level authoring gate. Every route under `dashboard/simulators/**`
 ...
 * nothing after this call executes when the guard fails. Mirrors
 * `courses/_lib/require-instructor.ts`.
 */
