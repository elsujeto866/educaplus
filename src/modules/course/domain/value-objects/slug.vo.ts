/**
 * Slug value object — URL-safe identifier for a course within an academy.
 *
 * Rules:
 *  - 3–63 characters
 ...
 *
 * Uniqueness per academy is enforced by the use-case layer (repository check),
 * not here. This VO validates only the structural format.
 *
