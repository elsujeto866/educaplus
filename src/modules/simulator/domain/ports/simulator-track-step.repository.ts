...
export interface SimulatorTrackStepRepository {
  ...
  /**
   * Bulk-rewrites positions for the given steps — used by
   * ReorderTrackSteps/RemoveTrackStep to re-compact the contiguous 1..N
   * sequence after a swap or a deletion. All updates run inside the same
