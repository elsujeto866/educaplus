/**
 * computeReorderedIds — pure function driving the module up/down reorder
 * actions. No mocks: given the full ordered id list and a target id, it
 * returns a NEW array with the target swapped with its neighbor, or the
 * SAME array reference when the move is a no-op (already at the boundary).
 */

import { describe, it, expect } from 'vitest';
import { computeReorderedIds } from '../../../src/app/dashboard/courses/[courseId]/_lib/reorder';
